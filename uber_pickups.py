...
# Create a text element and let the reader know the date is loading
data_load_state = st.text("Loading data...")
# Load 10,000 rows of data into the dataframe
data = load_data (10000)
# Notify the reader that the data was successfullt loaded
...
st.subheader('Map of adll pickups at %s:00' % hour_to_filter)
st.map(filtred_data)
